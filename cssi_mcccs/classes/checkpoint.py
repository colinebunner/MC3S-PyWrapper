...
class Checkpoint:
  ...
  def __init__(self,allowCheckpoint=False,checkpoint_interval=None,checkpoint_copies=None,
               use_checkpoint=None,changeLog=[],errorLog=[]):
  ...
  def allowCheckpoint(self,val):
    if isinstance(val,bool):
      self.__changeLog.append({'Date':datetime.datetime.now(),'Module':'Checkpoint',
      ...
      self.__errorLog.append({'Date':datetime.datetime.now(),'Type':'Setter','Module':'Checkpoint',
  ...
  def checkpoint_copies(self,val):
    if utilities.is_positive_integer:
      self.__changeLog.append({'Date':datetime.datetime.now(),'Module':'Checkpoint',
